...
build-sdl2:
    ...
    gcc -no-pie -DRG_TARGET_SDL2 -DRETRO_GO -DCJSON_HIDE_SYMBOLS -DSDL_MAIN_HANDLED=1 -DRG_BUILD_INFO=\"SDL2\" -Dapp_main=SDL_Main $(sdl2-config --cflags) -Icomponents/shared -Icomponents/shared/libs/cJSON -Icomponents/shared/libs/lodepng -Icomponents/shared/libs/miniz -Icomponents/emu/components/gb -Icomponents/emu/components/nes -Icomponents/emu/components/pce -Icomponents/emu/components/sms -Icomponents/emu/main components/shared/*.c components/shared/drivers/audio/*.c components/shared/fonts/*.c components/shared/libs/cJSON/*.c components/shared/libs/lodepng/*.c components/shared/libs/miniz/*.c components/emu/components/gb/*.c components/emu/components/gb/mapper/*.c components/emu/components/nes/*.c components/emu/components/nes/mapper/*.c components/emu/components/pce/*.c components/emu/components/sms/*.c components/emu/components/sms/sound/*.c components/emu/components/sms/sound_output/dummy/*.c components/emu/components/sms/sound/maxim_sn76489/*.c components/emu/components/sms/cpu_cores/z80/*.c components/emu/main/*.c $(sdl2-config --libs) -lstdc++ -o emu.exe
