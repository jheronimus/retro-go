...
build-sdl2:
    ...
    gcc -no-pie -DRG_TARGET_SDL2 -DRETRO_GO -DCJSON_HIDE_SYMBOLS -DSDL_MAIN_HANDLED=1 -DRG_BUILD_INFO=\"SDL2\" -Dapp_main=SDL_Main $(sdl2-config --cflags) -Icomponents/shared -Icomponents/shared/libs/cJSON -Icomponents/shared/libs/lodepng -Icomponents/shared/libs/miniz -Icomponents/emu/components/gb -Icomponents/emu/components/nes -Icomponents/emu/components/pce -Icomponents/emu/components/sms -Icomponents/emu/main components/shared/*.c components/shared/drivers/audio/*.c components/shared/fonts/*.c components/shared/libs/cJSON/*.c components/shared/libs/lodepng/*.c components/shared/libs/miniz/*.c components/emu/components/gb/*.c components/emu/components/gb/mapper/*.c components/emu/components/nes/src/*.c components/emu/components/nes/src/mapper/*.c components/emu/components/pce/*.c components/emu/components/sms/source/*.c components/emu/components/sms/source/sound/*.c components/emu/components/sms/source/sound_output/dummy/*.c components/emu/components/sms/source/sound/maxim_sn76489/*.c components/emu/components/sms/source/cpu_cores/z80/*.c components/emu/main/*.c $(sdl2-config --libs) -lstdc++ -o emu.exe
...
build-fw:
    ...
    python tools/firmware-utils/mkfw.py --type esplay --name Retro-Go --icon components/launcher/assets/icon.raw --version experimental retro-go_mrgc-g32.fw --target mrgc-g32 --bootloader components/launcher/build/bootloader/bootloader.bin 0 16 1048576 launcher components/launcher/build/launcher.bin 0 17 1048576 emu components/emu/build/emu.bin
